...
B = 30  # Magnetic field strength in Tesla, used as a containment field
initial_acceleration = 0.1  # Initial acceleration in m/s^2
max_acceleration = 9.81  # Maximum gravitational acceleration in m/s^2
...
# Time parameters
total_time = 9600  # Total simulation time in seconds
...
for i in range(1, len(time_array)):
    try:
        ...
        if i % observer_interval == 0 and current_observers < 1e6:
            current_observers += 1  # Slowly increase the number of observers
